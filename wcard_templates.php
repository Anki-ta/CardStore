...
<div class="img"><a target="_blank" href="<?php echo $link_address.$num.$extn;?>"><img src="<?php echo $row['imgPath'].$row['imgName'];?>" style="width:100%; height:200px;"></a>
