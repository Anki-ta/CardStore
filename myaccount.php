...
/*if((isset($_SESSION['type']) && isset($_SESSION['emaila']))){
	
	$_type=$_SESSION['type'];
	echo $_type;
	$_email=$_SESSION['emaila'];
	$sql_user="select * from admin where Email='$_email'";
$accounta=mysqli_query($connect,$sql_user);
$detaila=mysqli_fetch_array($accounta);
	}*/
?>
<html>
<head>
<title>CardStore---My Account</title>
...
<div class="content">
<center style="background-color:white;"><a href="Homepage.php" class="LinkColor"><font face=Comic Sans MS >Home</font></a>
<font color=#b4bcc0>&nbsp > &nbsp</font>
<font face=Comic Sans MS color=#F7468A>My Account</font></a></center><hr><br/>
